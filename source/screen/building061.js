...
import Bottombar061 from '../component/bottomBar061'; // 하단 버튼 바
...
const Building061 = () => {
  return (
      <Stack.Navigator>
        <Stack.Screen
          name="Building061Main"
          component={Building061Main}
...
const Building061Main = ({navigation}) => {
  return (
    <SafeAreaProvider>
